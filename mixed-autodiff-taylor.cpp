...
#line 1 "regression-tests/mixed-autodiff-taylor.cpp2"
...
#line 7 "regression-tests/mixed-autodiff-taylor.cpp2"
...
[[nodiscard]] auto test_sub(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_sub_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 12 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(0.0);
  y.construct(taylor());
...
[[nodiscard]] auto test_mul(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_mul_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 20 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(x0);
  y.construct(x);
{
auto i{0};

#line 24 "regression-tests/mixed-autodiff-taylor.cpp2"
  for( ; cpp2::impl::cmp_less(i,6); i += 1 ) {
    y.value() = y.value().mul(x, y0.value(), x0);
    y0.value() *= x0;
  }
}
#line 25 "regression-tests/mixed-autodiff-taylor.cpp2"
    return  { std::move(y0.value()), std::move(y.value()) }; 

#line 28 "regression-tests/mixed-autodiff-taylor.cpp2"
}
...
[[nodiscard]] auto test_div(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_div_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 31 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(1.0);
  y.construct(taylor());
...
[[nodiscard]] auto test_sqrt(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_sqrt_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 39 "regression-tests/mixed-autodiff-taylor.cpp2"
...
[[nodiscard]] auto test_log(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_log_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 44 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(log(x0));
...
[[nodiscard]] auto test_exp(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_exp_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 49 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(exp(x0));
...
[[nodiscard]] auto test_sin(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_sin_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 54 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(sin(x0));
...
[[nodiscard]] auto test_cos(cpp2::impl::in<double> x0, cpp2::impl::in<taylor> x) -> test_cos_ret{
      cpp2::impl::deferred_init<double> y0;
      cpp2::impl::deferred_init<taylor> y;
#line 59 "regression-tests/mixed-autodiff-taylor.cpp2"
  y0.construct(cos(x0));
...
#line 68 "regression-tests/mixed-autodiff-taylor.cpp2"
...
#line 71 "regression-tests/mixed-autodiff-taylor.cpp2"
}
