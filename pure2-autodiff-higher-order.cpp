...
#line 1 "regression-tests/pure2-autodiff-higher-order.cpp2"

#line 4 "regression-tests/pure2-autodiff-higher-order.cpp2"
namespace ad_name {

#line 10 "regression-tests/pure2-autodiff-higher-order.cpp2"
class type_outer;
  
  class type_outer_d;


#line 18 "regression-tests/pure2-autodiff-higher-order.cpp2"
class ad_test;

#line 196 "regression-tests/pure2-autodiff-higher-order.cpp2"
}
...
#line 2 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 6 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 16 "regression-tests/pure2-autodiff-higher-order.cpp2"
};
...
#line 84 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 100 "regression-tests/pure2-autodiff-higher-order.cpp2"
    public: [[nodiscard]] static auto if_else_branch(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> if_else_branch_ret;

#line 109 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 113 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 119 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 127 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 134 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 141 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 148 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 157 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 168 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 182 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 189 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 195 "regression-tests/pure2-autodiff-higher-order.cpp2"
};
}
...
#line 207 "regression-tests/pure2-autodiff-higher-order.cpp2"
auto main() -> int;
...
#line 7 "regression-tests/pure2-autodiff-higher-order.cpp2"
  ret.construct(x + y);
return std::move(ret.value()); }

#line 13 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 21 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x + y);
...
#line 24 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::add_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> add_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 25 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x + y + x);
    return std::move(r.value()); }
...
#line 28 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::sub_1(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> sub_1_ret{
            cpp2::impl::deferred_init<double> r;
#line 29 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x - y);
    return std::move(r.value()); }
...
#line 32 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::sub_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> sub_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 33 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x - y - x);
    return std::move(r.value()); }
...
#line 36 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::add_sub_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> add_sub_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 37 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x + y - x);
    return std::move(r.value()); }
...
#line 40 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::mul_1(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> mul_1_ret{
            cpp2::impl::deferred_init<double> r;
#line 41 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x * y);
    return std::move(r.value()); }
...
#line 44 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::mul_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> mul_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 45 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x * y * x);
    return std::move(r.value()); }
...
#line 48 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::div_1(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> div_1_ret{
            cpp2::impl::deferred_init<double> r;
#line 49 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 52 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::div_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> div_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 53 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 56 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::mul_div_2(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> mul_div_2_ret{
            cpp2::impl::deferred_init<double> r;
#line 57 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 60 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::mul_add(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> mul_add_ret{
            cpp2::impl::deferred_init<double> r;
#line 61 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x * (x + y));
    return std::move(r.value()); }
...
#line 64 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::add_mul(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> add_mul_ret{
            cpp2::impl::deferred_init<double> r;
#line 65 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(x + x * y);
    return std::move(r.value()); }
...
#line 68 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::prefix_add(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> prefix_add_ret{
            cpp2::impl::deferred_init<double> r;
#line 69 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(+x + y);
    return std::move(r.value()); }
...
#line 72 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::prefix_sub(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> prefix_sub_ret{
            cpp2::impl::deferred_init<double> r;
#line 73 "regression-tests/pure2-autodiff-higher-order.cpp2"
        r.construct(-x + y);
    return std::move(r.value()); }
...
#line 76 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::func(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> func_ret{
          cpp2::impl::deferred_init<double> ret;
#line 77 "regression-tests/pure2-autodiff-higher-order.cpp2"
      ret.construct(x + y);
    return std::move(ret.value()); }
...
#line 80 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::func_call(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> func_call_ret{
          cpp2::impl::deferred_init<double> r;
#line 81 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 84 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::func_outer_call(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> func_outer_call_ret{
          cpp2::impl::deferred_init<double> r;
#line 85 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 88 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::sin_call(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> sin_call_ret{
          cpp2::impl::deferred_init<double> r;
#line 89 "regression-tests/pure2-autodiff-higher-order.cpp2"
      r.construct(sin(x - y));
    return std::move(r.value()); }
...
#line 92 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::if_branch(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> if_branch_ret{
          cpp2::impl::deferred_init<double> r;
#line 93 "regression-tests/pure2-autodiff-higher-order.cpp2"
      r.construct(x);
...
#line 100 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::if_else_branch(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> if_else_branch_ret{
          cpp2::impl::deferred_init<double> r;
#line 101 "regression-tests/pure2-autodiff-higher-order.cpp2"
      if (cpp2::impl::cmp_less(x,0.0)) {
        r.construct(y);
      }
      else {
...
#line 113 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::intermediate_var(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> intermediate_var_ret{
          cpp2::impl::deferred_init<double> r;
#line 114 "regression-tests/pure2-autodiff-higher-order.cpp2"
      double t {x + y}; 
...
#line 119 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::intermediate_passive_var(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> intermediate_passive_var_ret{
          cpp2::impl::deferred_init<double> r;
#line 120 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 127 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::intermediate_untyped(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> intermediate_untyped_ret{
          cpp2::impl::deferred_init<double> r;
#line 128 "regression-tests/pure2-autodiff-higher-order.cpp2"
      auto t {0.0}; 
      t = x + y;
...
#line 134 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::intermediate_default_init(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> intermediate_default_init_ret{
          cpp2::impl::deferred_init<double> r;
#line 135 "regression-tests/pure2-autodiff-higher-order.cpp2"
      double t {}; 
      t = x + y;
...
#line 141 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::intermediate_no_init(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> intermediate_no_init_ret{
          cpp2::impl::deferred_init<double> r;
#line 142 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 148 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::while_loop(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> while_loop_ret{
          cpp2::impl::deferred_init<double> r;
#line 149 "regression-tests/pure2-autodiff-higher-order.cpp2"
      int i {0}; 
...
#line 157 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::do_while_loop(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> do_while_loop_ret{
          cpp2::impl::deferred_init<double> r;
#line 158 "regression-tests/pure2-autodiff-higher-order.cpp2"
      int i {0}; 
...
#line 168 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::for_loop(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> for_loop_ret{
          cpp2::impl::deferred_init<double> r;
#line 169 "regression-tests/pure2-autodiff-higher-order.cpp2"
      std::vector<double> v {}; 
...
#line 182 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::type_outer_use(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> type_outer_use_ret{
          cpp2::impl::deferred_init<double> r;
#line 183 "regression-tests/pure2-autodiff-higher-order.cpp2"
      type_outer t {}; 
      t.a = x;
...
#line 189 "regression-tests/pure2-autodiff-higher-order.cpp2"
    [[nodiscard]] auto ad_test::type_outer_call(cpp2::impl::in<double> x, cpp2::impl::in<double> y) -> type_outer_call_ret{
          cpp2::impl::deferred_init<double> r;
#line 190 "regression-tests/pure2-autodiff-higher-order.cpp2"
      type_outer t {}; 
      t.a = x;
...
#line 198 "regression-tests/pure2-autodiff-higher-order.cpp2"
auto write_output(cpp2::impl::in<std::string> func, cpp2::impl::in<double> x, cpp2::impl::in<ad_type> x_d, cpp2::impl::in<double> y, cpp2::impl::in<ad_type> y_d, auto const& ret) -> void{
...
#line 202 "regression-tests/pure2-autodiff-higher-order.cpp2"
...
#line 205 "regression-tests/pure2-autodiff-higher-order.cpp2"
}

#line 207 "regression-tests/pure2-autodiff-higher-order.cpp2"
auto main() -> int{

#line 210 "regression-tests/pure2-autodiff-higher-order.cpp2"
    double x {2.0}; 
    ad_type x_d {1.0}; 
    double y {3.0}; 
    ad_type y_d {2.0}; 
