...
#line 1 "source/io2.h2"

#line 17 "source/io2.h2"
namespace cpp2 {

#line 68 "source/io2.h2"
class is_preprocessor_ret;
    

#line 254 "source/io2.h2"
class pre_if_depth_info;

#line 288 "source/io2.h2"
class braces_tracker;

#line 393 "source/io2.h2"
}
...
class pre_if_depth_info {
    ...
    public: explicit pre_if_depth_info();

#line 262 "source/io2.h2"
    public: auto found_open_brace() & -> void;

#line 267 "source/io2.h2"
    public: auto found_close_brace() & -> void;

#line 272 "source/io2.h2"
    public: [[nodiscard]] auto found_preprocessor_else_was_there_another() & -> bool;

#line 280 "source/io2.h2"
    public: [[nodiscard]] auto braces_to_ignore() const& -> cpp2::i32;
    public: pre_if_depth_info(pre_if_depth_info const& that);
public: pre_if_depth_info(pre_if_depth_info&& that) noexcept;


#line 286 "source/io2.h2"
};
...
#line 259 "source/io2.h2"
    pre_if_depth_info::pre_if_depth_info(){
    }
...
#line 280 "source/io2.h2"
    ...
    pre_if_depth_info::pre_if_depth_info(pre_if_depth_info const& that)
                                     : if_net_braces{ that.if_net_braces }
                                     , found_else{ that.found_else }
                                     , else_net_braces{ that.else_net_braces }{}
pre_if_depth_info::pre_if_depth_info(pre_if_depth_info&& that) noexcept
                                     : if_net_braces{ std::move(that).if_net_braces }
                                     , found_else{ std::move(that).found_else }
                                     , else_net_braces{ std::move(that).else_net_braces }{}
...
#line 298 "source/io2.h2"
    auto braces_tracker::found_open_brace(cpp2::impl::in<lineno_t> lineno, cpp2::impl::in<char> brace) & -> void{
        ...
        if (current_open_type == brace) {
            ...
            CPP2_UFCS(found_open_brace)(CPP2_UFCS(back)(preprocessor));
        }
    }
...
#line 308 "source/io2.h2"
    auto braces_tracker::found_close_brace(cpp2::impl::in<source_position> pos, cpp2::impl::in<char> brace) & -> void{
            ...
            || (current_open_type == '(' && brace == ')')) 
        {
            ...
            CPP2_UFCS(found_close_brace)(CPP2_UFCS(back)(preprocessor));
        }
    }
    ...
    auto braces_tracker::found_eof(cpp2::impl::in<source_position> pos) & -> void{
        if (current_depth() != 0) {
            ...
            while( cpp2::impl::cmp_less(i,std::ssize(open_braces)) ) {
                if (cpp2::impl::cmp_greater(i,0) && cpp2::impl::cmp_greater(std::ssize(open_braces),2)) {unmatched = unmatched + ",";}
...
#line 353 "source/io2.h2"
    auto braces_tracker::found_pre_if([[maybe_unused]] cpp2::impl::in<lineno_t> unnamed_param_2) & -> void{
        CPP2_UFCS(push_back)(preprocessor, pre_if_depth_info());
    }
...
#line 357 "source/io2.h2"
    auto braces_tracker::found_pre_else(cpp2::impl::in<lineno_t> lineno) & -> void{
        ...
        if (CPP2_UFCS(found_preprocessor_else_was_there_another)(CPP2_UFCS(back)(preprocessor))) {
            static_cast<void>(CPP2_UFCS(emplace_back)((*cpp2::impl::assert_not_null(error_list)), 
                lineno, 
...
#line 373 "source/io2.h2"
    auto braces_tracker::found_pre_endif(cpp2::impl::in<lineno_t> lineno) & -> void{
        ...
        cpp2::i32 i {0}; 
        while( cpp2::impl::cmp_less(i,CPP2_UFCS(braces_to_ignore)(CPP2_UFCS(back)(preprocessor))) ) {
            char close_brace {')'}; 
