...
#line 1 "regression-tests/pure2-try-catch.cpp2"
...
#line 7 "regression-tests/pure2-try-catch.cpp2"
auto f(cpp2::impl::in<int> x) -> void;

#line 11 "regression-tests/pure2-try-catch.cpp2"
auto main() -> int;
...
#line 1 "regression-tests/pure2-try-catch.cpp2"
[[nodiscard]] auto throwing_pred([[maybe_unused]] cpp2::impl::in<int> unnamed_param_1) -> bool
#line 2 "regression-tests/pure2-try-catch.cpp2"
{
    throw(42);
    return false; 
}
